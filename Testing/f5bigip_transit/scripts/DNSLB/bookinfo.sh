...
#	x_id=('7c129eb1-c479-47bb-9c73-d263e2673026' '7c129eb1-c479-47bb-9c73-d263e2673026' '7c129eb1-c479-47bb-9c73-d263e2673026' '7c129eb1-c479-47bb-9c73-d263e2673026' '7742c954-7534-4e76-8828-9e548908958d' '7742c954-7535-4e76-8828-9e548908958d' '7742c954-8534-4e76-8828-9e548908958d' '9caa8d15-7851-41b0-91c4-512b34f20ea4' '9caa8d15-7851-41b0-91c4-512b34f20ea4' '9caa8d15-7851-41b0-91c4-512b34f20ea4' '7742c954-7554-4e76-8828-9e548908958d' '9caa8d15-7851-41b0-91c4-512b34f20ea4')
	...
	id=${x_id[`echo "$seed % 5" | bc`]}

	#curl -k -H "X-Forwarded-For:$xff_ip" https://bookinfo.f5se.io/productpage?u=normal 
	#curl -k -H "X-Forwarded-For:$xff_ip" https://bookinfo.f5se.io/productpage?u=test
	echo "-------with agent & X-ID----------"
	curl -k -H "user-agent: $ua" -H "X-Request-ID: $id" https://bookinfo.f5se.io
	curl -k -H "user-agent: $ua" -H "X-Request-ID: $id" https://bookinfo.f5se.io/productpage?u=normal 
	curl -k -H "user-agent: $ua" -H "X-Request-ID: $id"  https://bookinfo.f5se.io/productpage?u=test
	#echo "------------------------"
	#curl -k -H "user-agent: $ua"  https://bookinfo.f5se.io
	#curl -k -H "user-agent: $ua"  https://bookinfo.f5se.io/productpage?u=normal 
	#curl -k -H "user-agent: $ua"  https://bookinfo.f5se.io/productpage?u=test
	echo "------ $xff_ip ---------"
	echo "$id"
	sleep 1
done
